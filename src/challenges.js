...
function howManyTimes(arg1, words) {
  let count = 0
...
function multiplyBy(array, numbers) {
  const arraysDone = []
  array.forEach(element => {
    arraysDone.push(element*numbers)
  })
  return arraysDone;
}
